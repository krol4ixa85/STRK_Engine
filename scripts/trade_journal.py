...
# -*- coding: utf-8 -*-
"""
trade_journal.py · v1.0 · 21.08.2026
...
3. Сверка с движком · четыре категории:
   ...
   AGAINST        вошла когда движок говорил НЕ ВХОДИТЬ или ЖДАТЬ
...
def classify_trade(pos, decisions):
    ...
    # Шорт при сигнале не входить — тоже согласие с движком
    if action == "НЕ ВХОДИТЬ" and side == "SHORT":
        return {"category": "FOLLOWED",
                "text_ru": "шорт при сигнале НЕ ВХОДИТЬ — согласуется с движком",
                "decision": d}
